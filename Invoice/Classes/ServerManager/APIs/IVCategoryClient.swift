...
class IVCategoryClient: NSObject {
    
    open class func getRequestBuilderForCategories() -> RequestBuilder< [String : Any] >
    {
        let path = IVAPIHelper.getPath(type:IVAPIType.categories)
