...
class IVCompanyClient: NSObject {
    
    open class func getRequestBuilderForCompanies() -> RequestBuilder< [String : Any] >
    {
        let path = IVAPIHelper.getPath(type:IVAPIType.companies)
